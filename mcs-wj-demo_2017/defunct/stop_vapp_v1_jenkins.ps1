### stop_vapp v1
###   .\stop_vapp.ps1 -ciServer "vcloud.macquarieview.com" -vappName "WJ-DEV-NODE01" -orgVdc "M2SVC20637001" -orgname "Webjet_Marketing_Pty_Ltd_42809_SVC" -apiusername "devadmin" -apipassword "P@ssw0rd"
...
Start-Transcript .\StopVapp-$env:vappname.txt -append -noclobber
